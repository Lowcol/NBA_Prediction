...
# === Load your dataset ===
df = pd.read_csv('NBAdata/NBA_Training_Matchups_2019_2025.csv')
...
# Save best model (Bagging SVC)
# best_model = models["Bagging SVC"]
# joblib.dump(best_model, "NBAdata/best_model.pkl")
# joblib.dump(scaler, "NBAdata/scaler.pkl")
# print("✅ Saved Bagging SVC as best_model.pkl")
